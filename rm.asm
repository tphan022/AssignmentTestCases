...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    105a:	c7 44 24 04 a1 1a 00 	movl   $0x1aa1,0x4(%esp)
    1061:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    141a:	0f b6 80 f0 1a 00 00 	movzbl 0x1af0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1578:	75 27                	jne    15a1 <printf+0x120>
          s = "(null)";
    157a:	c7 45 e4 ba 1a 00 00 	movl   $0x1aba,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1647:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1708:	a3 0c 1b 00 00       	mov    %eax,0x1b0c
}
    170d:	c9                   	leave  
    170e:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1760:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
}
    1765:	c9                   	leave  
    1766:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    177c:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
    1781:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1784:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1788:	75 23                	jne    17ad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    178a:	c7 45 f0 04 1b 00 00 	movl   $0x1b04,-0x10(%ebp)
    1791:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1794:	a3 0c 1b 00 00       	mov    %eax,0x1b0c
    1799:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
    179e:	a3 04 1b 00 00       	mov    %eax,0x1b04
    base.s.size = 0;
    17a3:	c7 05 08 1b 00 00 00 	movl   $0x0,0x1b08
    17aa:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1800:	a3 0c 1b 00 00       	mov    %eax,0x1b0c
      return (void*)(p + 1);
    ...
    if(p == freep)
    180d:	a1 0c 1b 00 00       	mov    0x1b0c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    18ec:	c7 44 24 04 c1 1a 00 	movl   $0x1ac1,0x4(%esp)
    18f3:	00 
    ...
    1931:	c7 44 24 04 cf 1a 00 	movl   $0x1acf,0x4(%esp)
    1938:	00 
    ...
    195d:	c7 44 24 04 dc 1a 00 	movl   $0x1adc,0x4(%esp)
    1964:	00 
